...
public:
	...
	+/
    void approx(alias func, ReturnType, InputTypes...)(InputTypes inputs, ReturnType expected)
    {
        ...
        {
            writeln(cast(string) TerminalColor.L_Green, __traits(identifier,
                    func), "(", inputs, ") = ", expected);
        }
        else
        {
            writeln(cast(string) TerminalColor.Red, __traits(identifier, func),
